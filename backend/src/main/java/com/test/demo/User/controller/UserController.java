...
public class UserController {
    ...
    JSONObject settingForConfig(@RequestBody String projectIdAndSetting, @PathVariable("account") String account) throws IOException, JSONException, ParseException, EncodeException {
      logger.info("projectIdAndSetting:"+projectIdAndSetting);
...
//        logger.info("boardChoice:"+boardChoice);
...
//    JSONObject connectHook(@PathVariable("account") String account) throws IOException, EncodeException, ParseException, InterruptedException {
//        WebSocket.sendMessageToUser(statusHelper.onlySuccess().toString(), account);
//        return statusHelper.jsonObject2Success(userService.getDBAllData(account));
//    }
//    //需要传进来一个account
//    @RequestMapping(value = "cards/", method = RequestMethod.DELETE)
//    String deleteCard(@RequestBody String userCard) throws IOException, JSONException, ParseException {
//    String returnJson = "";
//        return returnJson;
//    }
//    @RequestMapping(value = "/info", method = RequestMethod.PUT)
//    public JSONObject register(@RequestBody User user) throws  JSONException {
