...
@Getter
@Component
public class SocketHashHandle2 {
    private final int width = 2;
    private static int hashNumber = 0;
    public static ConcurrentHashMap<Integer, WebSocket2Handler> webSocketSet = new ConcurrentHashMap<>();
    public static Queue<WebSocket2Handler> leftSocket = new SynchronousQueue<>();
    ...
    public void setSocket2Queue(WebSocket2Handler webSocket){
